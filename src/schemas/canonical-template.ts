...
export const ContentBlock = z.object({
  ...
  // Reviewer annotation fields — written by Content Designer editor tool
...
export const CanonicalTemplate = z.object({
  ...
  // editor_status: human editorial decision — distinct from MappingResult.review_status (pipeline match status)
